      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-slate-custom">AI Job Matcher</h1>
          </div>
          <nav className="hidden md:flex items-center space-x-6">
            <a href="#" className="text-slate-custom hover:text-primary transition-colors">Dashboard</a>
            <a href="#" className="text-slate-custom hover:text-primary transition-colors">My Applications</a>
            <a href="#" className="text-slate-custom hover:text-primary transition-colors">Profile</a>
            <Button className="bg-primary text-white hover:bg-blue-700">
              <User className="mr-2 w-4 h-4" />
              Account
            </Button>
          </nav>
          <Button variant="ghost" size="icon" className="md:hidden text-slate-custom">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <JobListings jobs={jobs} isLoading={jobsLoading} />
          </div>
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-slate-custom">AI Job Matcher</span>
              </div>
              <p className="text-gray-600 text-sm">Intelligent job matching powered by AI to connect talent with opportunity.</p>
            </div>
            ...
            <div>
              <h4 className="font-semibold text-slate-custom mb-4">Resources</h4>
              <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600">© 2024 AI Job Matcher. All rights reserved.</p>
